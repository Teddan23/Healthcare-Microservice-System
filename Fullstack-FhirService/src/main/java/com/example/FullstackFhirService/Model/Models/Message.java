...
import com.example.FullstackFhirService.Controller.DTOs.MessageDTO;
...
public class Message {
    ...
    public static Message fromDTO(MessageDTO dto) {
        ...
        message.sender = User.fromDTO(dto.getSender()) ;  // Mappad User från databasen
        message.receiver = User.fromDTO(dto.getReceiver());  // Mappad User från databasen
